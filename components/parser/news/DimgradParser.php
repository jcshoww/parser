...
/**
 * News parser from site https://dimgrad24.ru/
 * @author jcshow
 */
class DimgradParser implements ParserInterface
{
    public const USER_ID = 2;

    public const FEED_ID = 2;

    public const SITE_URL = 'https://dimgrad24.ru';
    ...
    public static function getNewsData(): array
    {
        ...
        /** Get RSS news list */
        $curl = Helper::getCurl();
        $newsList = $curl->get(static::SITE_URL . "/feed.xml");
        if (! $newsList) {
    ...
    public static function getPostDetail(DOMElement $item): NewsPost
    {
        ...
        self::removeNodes($crawler, '
            //div[contains(@class,"post-wrapper")]
            //div[contains(@class,"post-text")]
            //div[contains(@class,"news-info")]
        ');
        self::removeNodes($crawler, '
            //div[contains(@class,"post-wrapper")]
            //div[contains(@class,"post-text")]
            //div[contains(@class,"news-share")]
        ');
