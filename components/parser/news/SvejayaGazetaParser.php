...
/**
 * News parser from site https://svgz.ru/
 * @author jcshow
 */
class SvejayaGazetaParser implements ParserInterface
{
    public const USER_ID = 2;

    public const FEED_ID = 2;

    public const SITE_URL = 'https://svgz.ru';
    ...
    public static function getPostDetail(DOMElement $item)
    {
        ...
        ');
        self::removeNodes($crawler, '//header[contains(@id,"masthead")]');
        self::removeNodes($crawler, '//div[contains(@class,"af-breadcrumbs")]');
        self::removeNodes($crawler, '//*[contains(@class,"wp-block-latest-posts__list")]/following-sibling::*');
        self::removeNodes($crawler, '//*[contains(@class,"wp-block-latest-posts__list")]');

        //Get image if exists
        $picture = null;
        $imageBlock = $crawler->filterXPath('
            //div[contains(@class,"entry-content-wrap")]
            //div[contains(@class,"read-img")]
            //img[1]
        ')->getNode(0);
