...
/**
 * News parser from site https://provse24.ru/
 * @author jcshow
 */
class Provse24Parser implements ParserInterface
{
    public const USER_ID = 2;

    public const FEED_ID = 2;

    public const SITE_URL = 'https://provse24.ru';
    ...
    public static function getPostDetail(DOMElement $item): NewsPost
    {
        ...
        ');
        self::removeNodes($crawler, '
            //div[contains(@class,"rep-container")]
            //div[contains(@class,"entry-content")]
            //*[contains(@id,"content_pointer_id")]
        ');
        self::removeNodes($crawler, '
            //div[contains(@class,"rep-container")]
            //div[contains(@class,"entry-content")]
            //*[contains(@id,"widthChecker")]
        ');
        self::removeNodes($crawler, '
            //div[contains(@class,"rep-container")]
            //div[contains(@class,"entry-content")]
            //*[contains(@class,"percentPointerClass")]
        ');
