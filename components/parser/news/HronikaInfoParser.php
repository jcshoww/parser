...
/**
 * News parser from site https://hronika.info/
 * @author jcshow
 */
class HronikaInfoParser implements ParserInterface
{
    public const USER_ID = 2;

    public const FEED_ID = 2;

    public const SITE_URL = 'https://hronika.info';
    ...
    public static function getPostDetail(DOMElement $item): NewsPost
    {
        ...
        self::removeNodes($crawler, '
            ...
            //div[contains(@class,"penci-google-adsense")]
        ');
        self::removeNodes($crawler, '
            //article[contains(@class,"post")]
            //div[contains(@class,"entry-content")]
